...
<p>
  My wife is one of the best wedding photographers in Northern Nevada and
  California. And I wanted an excuse to dig deeper into Gatsby and GraphQL. So
  I've been working with her and a couple industry partners to create a shared
  page for them:{' '}
  <a
